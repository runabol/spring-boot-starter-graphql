...
1. **Waste**. Since we only want to get the movie `id`, `title` and the thumbnail for each movie, that's exactly what we are getting back. The most of collecting and transferring the data is completely eliminated.
